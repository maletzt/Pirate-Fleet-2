...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! The computer will automatically hit one of your ships!"
        static let ComputerHitMonster = "The computer has hit a sea monster! You will automatically hit one of the computer's ships!"
